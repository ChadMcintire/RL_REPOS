...
def main(cfg: DictConfig):
    ...
    working_dir = HydraConfig.get().run.dir
    print("Working dir:", working_dir)

    # Set MLflow tracking
    mlflow.set_tracking_uri("file://" + os.path.abspath(cfg.paths.log_dir))
    mlflow.set_experiment(cfg.experiment.name)

    
    with mlflow.start_run(run_name=cfg.experiment.run_name):  # Optional name
        mlflow.log_params({
